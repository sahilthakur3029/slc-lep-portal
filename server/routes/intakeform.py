...
def insertApplicant():
    ...
    s_c_teach_level, comments, p_major, p_major_weight, p_gender, p_gender_custom, p_gender_weight, waiver_accept, timestamp) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,
    %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s, (select localtimestamp(0)))"""
    cur.execute(sql, (d_j["firstName"], d_j["lastName"], d_j["email"], d_j["sid"], d_j["academicTitle"], d_j["residency"], d_j["major"], d_j["gender"], d_j["genderCustom"], 
